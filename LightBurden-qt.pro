...
fName1 = "LightBurden-Qt"
macx:TARGET = "LightBurden-Qt"
VERSION = 2.6.5.4
QMAKE_TARGET_BUNDLE_PREFIX = co.LightBurden
...
macx: {
    ...
    ICON = src/qt/res/icons/lightburden.icns
    TARGET = LightBurden-v2.6.5.0-qt
