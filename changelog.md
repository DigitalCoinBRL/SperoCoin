...
>$0006 2017/10/01<br>
In this update, the LightBurden-qt.pro file has been changed for compilation in the Linux environment.<br>
...
addnode=http://dnslightburden.ddnsking.com:55680<br>
...
(ui-> lineEditCoinControlChange-> setPlaceholderText (tr ("Enter the LightBurden address (e.g. Sjz75uKHzUQJnSdzvpiigEGxseKkDhQToX)"));)<br>
...
→ Changing copyrights, updating the start date of LightBurden works, being: "Copyright © 2022 The Lightburden developers" - Change in ".ts" files in the "src \ qt \ locale" folder<br>
...
→ Adding LightBurden.conf file opening from the Console Window menu<br>
...
→ [UPDATE] Arquivos de Compilação LightBurden-qt.pro e makefile.mingw usados em compilação Windows<br>
