...
namespace Checkpoints
{
    ...
    // LightBurden: synchronized checkpoint (centrally broadcasted)
    ...
    // LightBurden: get last synchronized checkpoint
    ...
    // LightBurden: only descendant of current sync-checkpoint is allowed
    ...
    // LightBurden: reset synchronized checkpoint to last hardened checkpoint
...
// LightBurden: sync-checkpoint master key
...
// LightBurden: verify signature of sync-checkpoint message
...
// LightBurden: process synchronized checkpoint
