...
const QString kBaseUrl = "https://exchange.lightburden.org/api/v2/";
const QString kBaseUrl2 = "https://blockchain.info/tobtc?currency=USD&value=1";
const QString kBaseUrl3 = "https://exchange.lightburden.org/api/v2/order_book.json?market=lbdnbtc&asks_limit=10&bids_limit=10";
QString lastp = "";
QString askp = "";
QString bidp = "";
QString highp = "";
...
connect(ui->lbdnexchange, SIGNAL(pressed()), this, SLOT( lbdnexchange()));
...
void SperoExchange::lbdnexchange()
{
    QDesktopServices::openUrl(QUrl("https://exchange.lightburden.org/markets/lbdnbtc"));
}
...
void SperoExchange::parseNetworkResponse( QNetworkReply *finished )
{
    ...
    QStringList data2 = data.split("{\"MarketName\":\"BTC-LBDN\",\"High\":");
