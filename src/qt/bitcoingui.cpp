    ...
    rpcConsole(0)
{
    ...
    setWindowTitle(tr("LightBurden") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    //lbdnExchange = new SperoExchange(this);
    ...
    //centralWidget->addWidget(lbdnExchange);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a LightBurden address"));
    ...
    charityAction->setToolTip(tr("Stake your LightBurden for a charity of your choice"));
...
/*    lbdnexchangeAction = new QAction(QIcon(":/icons/lbdnexchange"), tr("&Exchange"), this);
    lbdnexchangeAction->setToolTip(tr("Spero Exchange"));
    lbdnexchangeAction->setCheckable(true);
    tabGroup->addAction(lbdnexchangeAction);
*/
...
/*    connect(lbdnexchangeAction, SIGNAL(triggered()), this, SLOT(showNormalIfMinimized()));
    connect(lbdnexchangeAction, SIGNAL(triggered()), this, SLOT(gotoSperoExchange()));
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About LightBurden"), this);
    aboutAction->setToolTip(tr("Show information about LightBurden"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for LightBurden"));
...
void BitcoinGUI::createToolBars()
{
    ...
    //toolbar->addAction(lbdnexchangeAction);
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("LightBurden client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::setWalletModel(WalletModel *walletModel)
{
    ...
    if(walletModel)
    {
        ...
        //lbdnExchange->setModel(clientModel);
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("LightBurden client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to LightBurden network", "", count));
}
...
{
   lbdnexchangeAction->setChecked(true);
   centralWidget->setCurrentWidget(lbdnExchange);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid LightBurden address or malformed URI parameters."));
    }
