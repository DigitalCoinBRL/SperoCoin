...
{
   WalletModel::EncryptionStatus status = model->getEncryptionStatus();
   if (status == WalletModel::Locked) ui->unlockWalletButton->setText(QString("Unlock your LightBurden"));
   else ui->unlockWalletButton->setText(QString("Lock your LightBurden"));
}